...
[![GZip size](https://img.badgesize.io/https%3A%2F%2Fesm.sh%2Froute-event%2Fdist%2Findex.min.js?compression=gzip&style=flat-square)](https://esm.sh/route-event/dist/index.min.js)
